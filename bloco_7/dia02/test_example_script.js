...
// const c = division(9, 3);

// assert.strictEqual(division(9, 3), '3', 'Nove dividido por três é igual a três');
...
assert.strictEqual(division(10, 2), 5); // OK
assert.throws(() => { division(10, 0); }, /^Errorw: parameter y must not be 0$/); // OK
